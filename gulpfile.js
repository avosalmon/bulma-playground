...
gulp.task('uglify-js-lib', function(done) {
    gulp.src('dist/js/dependencies.js')
        .pipe(sourcemaps.init())
            .pipe(uglify())
...
gulp.task('watch-concat-js-main', function() {
    gulp.watch('js/**/*.js', ['concat-js-main']);
});

gulp.task('watch-uglify-js-main', function() {
    gulp.watch('dist/js/main.js', ['uglify-js-main']);
});
...
gulp.task('watch-uglify-js-lib', function() {
    gulp.watch('dist/js/dependencies.js', ['uglify-js-lib']);
});
